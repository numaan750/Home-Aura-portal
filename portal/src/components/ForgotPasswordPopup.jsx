        ...
        {step === 1 && (
          <form onSubmit={handleSendCode} className="space-y-4">
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-[#EAEAEA] text-[#1E1E1E80] outline-none"
            />
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 cursor-pointer bg-black text-white font-semibold rounded-xl "
            >
        ...
        {step === 2 && (
          <form onSubmit={handleVerifyCode} className="space-y-4">
            <input
              ...
              maxLength={6}
              className="w-full px-4 py-3 rounded-xl bg-[#EAEAEA] text-[#1E1E1E80] text-center text-2xl tracking-widest outline-none"
            />
            <button
              type="submit"
              disabled={loading}
          ...
          <form onSubmit={handleResetPassword} className="space-y-4">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 rounded-xl bg-[#EAEAEA] text-[#1E1E1E80] outline-none"
              />
              <button
                type="button"
